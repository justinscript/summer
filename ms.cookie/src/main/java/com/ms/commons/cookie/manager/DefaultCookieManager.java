...
import com.ms.commons.cookie.parser.CookieNameConfig;
import com.ms.commons.cookie.parser.CookieNameHelper;
import com.ms.commons.cookie.parser.CookieNamePolicyParser;
import com.ms.commons.cookie.parser.CookieParser;
 ...
 * </pre>
 * 
 * @author zxc Apr 12, 2014 7:40:03 PM
 */
public class DefaultCookieManager implements CookieManager {
     ...
     */
    private Map<CookieNameEnum, CookieNameHelper> currentCookieValue = new ConcurrentHashMap<CookieNameEnum, CookieNameHelper>();
    ...
    protected void init() {
        // 取得当前所有的Cookie值
        Map<CookieNameEnum, CookieNameHelper> newValues = CookieParser.loadCookie(request);
