...
import static com.ms.commons.cookie.CookieConstant.COOKIE_KEY_VALUE_SEPARATOR_CHAR;
import static com.ms.commons.cookie.CookieConstant.COOKIE_MAP_SEPARATOR_CHAR;
...
/**
 * @author zxc Apr 12, 2014 7:39:04 PM
 */
public class CookieUtils {
    ...
    public static String encrypt(String source) {
        return com.ms.commons.security.EncryptUtils.encrypt(source, ENCRYPT_KEY);
    }

    public static String decrypt(String source) {
        return com.ms.commons.security.EncryptUtils.decrypt(source, ENCRYPT_KEY);
    }
}
