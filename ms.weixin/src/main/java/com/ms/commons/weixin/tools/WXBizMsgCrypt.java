 ...
 * <ol>
 * <li>在官方网站下载JCE无限制权限策略文件（JDK7的下载地址： http://www.oracle.com/technetwork/java/javase/downloads/jce-7-download-432124.html
 * </li>
...
public class WXBizMsgCrypt {
     ...
     * @throws AesException
     */
    public boolean verifyMsg(String msgSignature, String timeStamp, String nonce, String encrypt) throws AesException {
        // 验证安全签名
        String signature;
        try {
