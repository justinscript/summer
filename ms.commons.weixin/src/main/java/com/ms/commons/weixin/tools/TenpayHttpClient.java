...
public class TenpayHttpClient {
    ...
    private static Logger       log              = LoggerFactory.getLogger(TenpayHttpClient.class);
    ...
    public boolean callHttpsPost(String url, String postdata) {
    ...
    private void callHttpsPost(String url, byte[] postData) throws IOException, CertificateException,
     ...
     */
    private SSLContext getSSLContent() throws CertificateException, IOException, FileNotFoundException,
