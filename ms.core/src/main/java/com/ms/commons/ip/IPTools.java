 ...
 * 而且国家记录和地区记录都有两种形式 1. 以0结束的字符串 2. 4个字节，一个字节可能为0x1或0x2 <br>
...
public class IPTools {
    ...
    // 纯真IP数据库(QQ)
    private String                        IP_FILE          = "/msun/data/ip_qqwry.dat";
    ...
    public static void main(String a[]) {
        String ip = "222.92.117.33";
        // String ip = "117.84.205.33";
        // String ip = "223.7.255.255";
