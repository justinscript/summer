...
import com.ms.commons.summer.web.view.ViewToolsFactory;
import com.ms.commons.summer.web.view.Widget;
import com.ms.commons.summer.web.view.tools.FormTool;

/**
 * @author zxc Apr 12, 2013 4:23:09 PM
 */
public class SummerVelocityLayoutView extends VelocityLayoutView {

    private static final ExpandLogger  logger                   = LoggerFactoryWrapper.getLogger(SummerVelocityLayoutView.class);
     ...
     * 是否要使用layout模版的key
     */
    public static final String         USE_LAYOUT               = "_$_velocity_user_layout_$_";
    ...
    public SummerVelocityLayoutView() {
    }
    ...
    protected Context createVelocityContext(Map model, HttpServletRequest request, HttpServletResponse response)
        ...
        // 注入widget
        Widget widget = new Widget(applicationContext, request, response);
        context.put("widget", widget);
        // 注入formtool
        FormTool formtool = new FormTool(request, response);
        context.put("formTool", formtool);
        return context;
    }
    ...
    protected void doRender(Context context, HttpServletResponse response) throws Exception {
        ...
        if (o != null && "true".equals(o.toString())) {
            renderScreenContent(context, response);
        }
        // 设置不需呀布局时，不需要布局
            ...
            String url = getUrl();
            Template t = getLayoutTemplate(url);
    ...
    private void renderScreenContent(Context context, HttpServletResponse response) throws Exception {
